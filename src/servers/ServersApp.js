...
import { view as ServersView } from "./ServersView";
...
class ServersApp extends Component {
    constructor(props) {
        super(props);
		
		this.props.dispatch(actions.replace(ServersView));
...
export default connect(mapStoreToProps)(ServersApp);
