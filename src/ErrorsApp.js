...
import { view as ErrorsView } from "../views/ErrorsView";
...
class ErrorsApp extends Component {
    constructor(props) {
        super(props);

		this.props.dispatch(actions.replace(ErrorsView));
...
export default connect(mapStoreToProps)(ErrorsApp);
